...
modules: `cors.md`, `csrf.md`, `csp.md`, `xss.md`, `headers.md`,
`hashing.md`, `encryption.md`, `rate-limit.md`, `secrets.md`, ... — each
will follow the same layout:
...
| CORS, CSRF, CSP, XSS, headers, hashing, encryption, rate limiting, secrets, audit | 🚧 planned | — | — |
